			...
			<form name="searchFrm" method="post" action="search.jsp">
				...
				<div>
					<select id="sectors" name="sectors" title="직종">
						<option value="sectors" class="select-holder" selected>직종</option>
					...
					<select id="workArea" name="workArea" title="근무지역">
						<option value="workArea" class="select-holder" selected>근무지역</option>
					...
					<select id="workType" name="workType" title="근무형태">
						<option value="workType" class="select-holder" selected>근무형태</option>
